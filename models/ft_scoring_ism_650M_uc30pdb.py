...
from ft_ism_score import ft_ism_score


# Define a mapping from method names to actual scoring functions
METHODS = {
    'ft_ism_650M_uc30pdb_score': ft_ism_score
}
...
def score(method, df):
    ...
    if 'light' not in test_df.columns:
        ...
        test_df['label_prediction'] = method(train_df, valid_df, test_df, 'ism_t33_650M_uc30pdb')
    else:
