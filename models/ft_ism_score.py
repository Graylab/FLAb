...
def ft_ism_score(train_df, valid_df, test_df, ism_model):
    """
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for data_name, df_path in zip(["train", "valid", "test"], [train_file, valid_file, test_file]):
            ...
            emb = create_embedding(f"{ism_model}", df, emb_type="per_prot") # an example for esm_model is 'esm2_t6_8M_UR50D'
