...
from ft_igfold2_score import ft_igfold2_structure_score


# Define a mapping from method names to actual scoring functions
METHODS = {
    'ft_igfold2_structure_score': ft_igfold2_structure_score
}
...
def score(method, df):
    ...
    if 'light' not in test_df.columns:
        ...
        test_df['label_prediction'] = method(train_df, valid_df, test_df)
    else:
